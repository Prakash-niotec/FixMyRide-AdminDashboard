      ...
      <div className="p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-md flex flex-col items-center">
        ...
        <form className="space-y-5 w-full" autoComplete="off" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              type="email"
              className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-900 ${emailError ? 'border-red-500' : ''}`}
          ...
          <button type="submit" className="w-full" style={{background:'#513FF3',color:'#fff',borderRadius:'0.5rem',padding:'0.5rem 0',fontWeight:600}}>Login</button>
        </form>
